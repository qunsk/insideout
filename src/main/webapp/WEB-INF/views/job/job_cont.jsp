	...
	<div class="container">
		...
		<div id="boardcont_menu"
			...
			<button type="button" class="btn btn-success"
				onclick="location='job_list?page=${page}&board_name=notice'">목록</button>

			<c:if test="${memtype != '0100'}">
				<button type="button" class="btn btn-success"
					onclick="location='/api/v1/staff/board_cont?post_no=${bcont.post_no}&page=${page}&state=edit&board_name=job'">수정</button>
				<button type="button" class="btn btn-success"
					onclick="location='/api/v1/staff/board_cont?post_no=${bcont.post_no}&page=${page}&state=del&board_name=job'">삭제</button>
			</c:if>
		</div>
	</div>
