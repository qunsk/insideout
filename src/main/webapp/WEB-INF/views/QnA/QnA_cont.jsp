		...
		<div id="boardcont_menu"
			...
			<c:if test="${memtype != '0100'}">
				<button type="button" class="btn btn-success"
					onclick="location='/api/v1/staff/board_cont?post_no=${bcont.post_no}&page=${page}&state=edit&board_name=QnA'">수정</button>
				<button type="button" class="btn btn-success"
					onclick="location='/api/v1/staff/board_cont?post_no=${bcont.post_no}&page=${page}&state=del&board_name=QnA'">삭제</button>
			</c:if>
		</div>
	</div>
